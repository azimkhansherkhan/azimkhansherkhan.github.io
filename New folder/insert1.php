...
<body>
<h2>insert to table hybridnyi</h2>
<ul>
<form name="insert" action="insert1.php" method="POST" >
...
$query = "insert into hybridnyi values ('$_POST[car_id]','$_POST[car_brand]','$_POST[car_model]','$_POST[produced_year]','$_POST[sell_count]')";
